...
{
    /// <summary>
    /// Decorator class for ship Forward
    /// </summary>
    public class ForwardShip : ShipDecorator
    {
        int[] parameters;
        public ForwardShip(Ship player) : base(player.position, player)
        {
            parameters = Features.getShipParameters(2);
        }
